...
export abstract class BaseDTO {
    ...
    toJSON(fields: Array<string>) {
        ...
        for (let field of listFieldSuccess) {
            res = cloneObj(res)
            res[field] = (this.obj[field] || typeof this.obj[field] == 'boolean' || typeof this.obj[field] == 'number')
                ? this.obj[field]
                : (this.default[field] != undefined ? this.default[field] : null)
            if (this.cast[field] instanceof Function)
                res[field] = this.cast[field](res[field]);
        }
        return res;
    }
